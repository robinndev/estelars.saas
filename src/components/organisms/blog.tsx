...
// Variantes de animação para o bloco de chamada
...
export const BlogCallout = () => {
  return (
    // Usa uma cor de fundo que complementa o gradiente do FAQ, mas com foco.
    <section className="relative w-full py-28 bg-white overflow-hidden">
      <div className="container mx-auto px-6 lg:px-20 relative z-10">
        {/* Bloco de Chamada Principal com Motion e Gradient Foda */}
        <motion.div
          variants={calloutVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          className="max-w-4xl mx-auto p-10 md:p-16 bg-gradient-to-br from-rose-500 to-red-600 rounded-3xl shadow-2xl shadow-rose-500/40"
        >
          <div className="text-center text-white">
            ...
            >
              <Link
                href="/blog" // Assume que a página do blog é /blog

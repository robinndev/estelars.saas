export const creationEmailSubject = (coupleName: string) =>
  `✨ Seu espaço “${coupleName}” está no ar — Hora de brilhar!`;

export const creationEmailPreview = (coupleName: string) =>
  `${coupleName}, seu site já está criado — confirme o pagamento e personalize tudo.`;
...
<head>
  ...
  <title>Seu site estelar está pronto</title>
  <style>
    body {
      margin:0; padding:0;
...
<body>
  ...
  <span style="display:none;max-height:0;overflow:hidden;opacity:0;">
    ${safeName}, seu site está pronto — confirme o pagamento e personalize tudo!
  </span>
  ...
  <div class="container">
    ...
    <h1>Olá ${safeName} — seu cantinho estelar já está no ar!</h1>
    <p class="lead">Criamos um site exclusivo pra vocês! Está tudo preparado.</p>

    <div class="card">
      <p style="margin:0;"><strong>O que fazer agora?</strong></p>
      <ul style="margin:12px 0 0 18px; padding:0;">
        <li class="muted">Clique no botão abaixo para confirmar o pagamento e liberar o acesso completo.</li>
        <li class="muted">Compartilhe com sua parceira ou amigos.</li>
      </ul>

      <div style="margin-top:18px;">
        <a class="cta" href="${cta}" target="_blank" rel="noopener noreferrer">Confirmar pagamento</a>
      </div>
      ...
      <p class="muted" style="margin-top:16px; font-size:12px; opacity:0.85;">
        Caso você já tenha pago, basta ignorar este e-mail — seu acesso será liberado automaticamente em alguns instantes. ✨
      </p>
    </div>
